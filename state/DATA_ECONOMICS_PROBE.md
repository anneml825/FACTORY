...
|---|---|---|---|---|---|---|---|
| `wordpress_active_installs` | INDIRECT | **100%** | 100% | 100% | 100% | 278ms | no |
| `wikipedia_pageviews` | WEAK | **57%** | 100% | 70% | 0% | 41ms | no |
| `wikipedia_search_hits` | WEAK | **100%** | 100% | 100% | 100% | 194ms | no |
| `stackexchange_questions` | INDIRECT | **100%** | 100% | 100% | 100% | 75ms | no |
| `hn_algolia_mentions` | INDIRECT | **100%** | 100% | 100% | 100% | 192ms | no |
| `npm_weekly_downloads` | INDIRECT | **19%** | 26% | 30% | 0% | 105ms | no |
...
| `hn_algolia_mentions` | 0.57 | 38% | 38% | 549 | 18 | 0 |
