...
|---|---|---|---|---|---|---|---|
| `wordpress_active_installs` | INDIRECT | **100%** | 100% | 100% | 100% | 7ms | no |
| `wikipedia_pageviews` | WEAK | **57%** | 100% | 70% | 0% | 4ms | no |
| `wikipedia_search_hits` | WEAK | **100%** | 100% | 100% | 100% | 196ms | no |
| `stackexchange_questions` | INDIRECT | **100%** | 100% | 100% | 100% | 69ms | no |
| `hn_algolia_mentions` | INDIRECT | **100%** | 100% | 100% | 100% | 190ms | no |
| `npm_weekly_downloads` | INDIRECT | **19%** | 26% | 30% | 0% | 21ms | no |
...
| `hn_algolia_mentions` | 0.58 | 37% | 37% | 551 | 18 | 0 |
