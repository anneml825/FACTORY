...
| `wikipedia_pageviews` | WEAK | **57%** | 100% | 70% | 0% | 54ms | no |
| `wikipedia_search_hits` | WEAK | **100%** | 100% | 100% | 100% | 217ms | no |
| `stackexchange_questions` | INDIRECT | **100%** | 100% | 100% | 100% | 74ms | no |
| `hn_algolia_mentions` | INDIRECT | **100%** | 100% | 100% | 100% | 189ms | no |
| `npm_weekly_downloads` | INDIRECT | **19%** | 26% | 30% | 0% | 110ms | no |
...
| `wikipedia_search_hits` | 0.80 | 11% | 11% | 11497 | 660 | 5 |
