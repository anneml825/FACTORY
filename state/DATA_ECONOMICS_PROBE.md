...
|---|---|---|---|---|---|---|---|
| `wordpress_active_installs` | INDIRECT | **100%** | 100% | 100% | 100% | 58ms | no |
| `wikipedia_pageviews` | WEAK | **57%** | 100% | 70% | 0% | 106ms | no |
| `wikipedia_search_hits` | WEAK | **100%** | 100% | 100% | 100% | 228ms | no |
| `stackexchange_questions` | INDIRECT | **100%** | 100% | 100% | 100% | 107ms | no |
| `hn_algolia_mentions` | INDIRECT | **100%** | 100% | 100% | 100% | 203ms | no |
| `npm_weekly_downloads` | INDIRECT | **19%** | 26% | 30% | 0% | 131ms | no |
...
| `wikipedia_search_hits` | 0.80 | 11% | 11% | 11498 | 661 | 5 |
| `stackexchange_questions` | 0.53 | 43% | 43% | 2523 | 5 | 0 |
| `hn_algolia_mentions` | 0.58 | 37% | 37% | 529 | 17 | 0 |
