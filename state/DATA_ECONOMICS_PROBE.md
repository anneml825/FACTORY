...
|---|---|---|---|---|---|---|---|
| `wordpress_active_installs` | INDIRECT | **100%** | 100% | 100% | 100% | 62ms | no |
| `wikipedia_pageviews` | WEAK | **57%** | 100% | 70% | 0% | 102ms | no |
| `wikipedia_search_hits` | WEAK | **100%** | 100% | 100% | 100% | 221ms | no |
| `stackexchange_questions` | INDIRECT | **100%** | 100% | 100% | 100% | 109ms | no |
| `hn_algolia_mentions` | INDIRECT | **100%** | 100% | 100% | 100% | 230ms | no |
| `npm_weekly_downloads` | INDIRECT | **19%** | 26% | 30% | 0% | 39ms | no |
...
| `hn_algolia_mentions` | 0.59 | 38% | 38% | 519 | 17 | 0 |
