...
|---|---|---|---|---|---|---|---|
| `wordpress_active_installs` | INDIRECT | **100%** | 100% | 100% | 100% | 328ms | no |
| `wikipedia_pageviews` | WEAK | **57%** | 100% | 70% | 0% | 107ms | no |
| `wikipedia_search_hits` | WEAK | **100%** | 100% | 100% | 100% | 231ms | no |
| `stackexchange_questions` | INDIRECT | **100%** | 100% | 100% | 100% | 95ms | no |
| `hn_algolia_mentions` | INDIRECT | **100%** | 100% | 100% | 100% | 211ms | no |
| `npm_weekly_downloads` | INDIRECT | **19%** | 26% | 30% | 0% | 200ms | no |
...
| `hn_algolia_mentions` | 0.56 | 37% | 37% | 496 | 17 | 0 |
| `npm_weekly_downloads` | 1.00 | 0% | 5% | 15979655 | 1991721 | — |
