...
|---|---|---|---|---|---|---|---|
| `wordpress_active_installs` | INDIRECT | **100%** | 100% | 100% | 100% | 77ms | no |
| `wikipedia_pageviews` | WEAK | **57%** | 100% | 70% | 0% | 89ms | no |
...
| `npm_weekly_downloads` | INDIRECT | **19%** | 26% | 30% | 0% | 88ms | no |
...
| `hn_algolia_mentions` | 0.56 | 37% | 37% | 550 | 14 | 0 |
