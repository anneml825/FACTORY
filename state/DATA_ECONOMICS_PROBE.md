...
|---|---|---|---|---|---|---|---|
| `wordpress_active_installs` | INDIRECT | **100%** | 100% | 100% | 100% | 289ms | no |
| `wikipedia_pageviews` | WEAK | **57%** | 100% | 70% | 0% | 55ms | no |
| `wikipedia_search_hits` | WEAK | **100%** | 100% | 100% | 100% | 192ms | no |
| `stackexchange_questions` | INDIRECT | **100%** | 100% | 100% | 100% | 88ms | no |
| `hn_algolia_mentions` | INDIRECT | **100%** | 100% | 100% | 100% | 217ms | no |
| `npm_weekly_downloads` | INDIRECT | **19%** | 26% | 30% | 0% | 73ms | no |
...
|---|---|---|---|---|---|---|
| `wordpress_active_installs` | 0.27 | 49% | 49% | 40000 | 1000 | 0 |
| `wikipedia_pageviews` | 0.98 | 2% | 4% | 7371 | 2733 | — |
| `wikipedia_search_hits` | 0.80 | 11% | 11% | 11503 | 662 | 5 |
| `stackexchange_questions` | 0.53 | 43% | 43% | 2522 | 5 | 0 |
| `hn_algolia_mentions` | 0.55 | 37% | 37% | 550 | 14 | 0 |
| `npm_weekly_downloads` | 1.00 | 0% | 5% | 19286093 | 2397889 | — |
