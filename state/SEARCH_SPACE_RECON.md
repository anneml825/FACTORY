...
|---|---|---|---|---|---|---|---|
| `wordpress_plugins` | yes | none | **100%** | 0.58 | 0% | 5000000 | 309ms |
| `vscode_extensions` | yes | none | **100%** | 1.00 | 0% | 19625 | 636ms |
| `atlassian_marketplace` | yes | none | **100%** | 1.00 | 0% | 1072 | 166ms |
| `pypi_packages` | **no** | none | **0%** | 0.00 | 0% | — | 26ms |
| `obsidian_plugins` | yes | none | **100%** | 1.00 | 0% | 7294943 | 303ms |
| `dockerhub_images` | yes | none | **100%** | 1.00 | 0% | 1411650 | 108ms |
| `crates_rust` | yes | none | **100%** | 1.00 | 0% | 43733 | 147ms |
| `homeassistant_hacs` | yes | **required** | **75%** | 0.89 | 11% | 10 | 276ms |
...
- **HTTP statuses:** {"200":12}
- **Values:** backup=19601, invoice=72, booking calendar=44002, seo=4494, inventory=125, form builder=70868756, analytics dashboard=97344, image optimization=4206408, membership=3189, csv import=23139481, time tracking=19625, pdf export=2706
